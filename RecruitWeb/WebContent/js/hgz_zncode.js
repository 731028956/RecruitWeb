...
{
	hyznstrVar += "<li><a href=\"javascript:;\" data-code=\""+znhycode[i].CodeValue+"\" data-name=\""+znhycode[i].CodeName+"\" class=\"d-cate\" onclick=\"show_second_node(this)\">"+znhycode[i].CodeName+"<\/a><\/li>";
	}
    hyznstrVar += "                                <\/ul>";
    hyznstrVar += "                              <\/div>";
    hyznstrVar += "                            <\/div>";
                     ...
                     //点击大类
						  ...
						  function show_zn_last(pid,phyid,phyname,lithis)
						  {
							  ...
							  var thirdnode=znhycode[pid].maxhycode[phyid].znhycdoe[k];
							   hyznstrVar += "<li><a title=\""+thirdnode.CodeName+"\" href=\"javascript:;\" data-code=\""+thirdnode.CodeValue+"\" data-name=\""+thirdnode.CodeName+"\" data-ditem=\""+thirdnode.CodeValue+"\" class=\"d-item\" onclick=\"ditem_select(this)\">"+thirdnode.CodeName+"<\/a><\/li>";		
							  }
						  ...
						  if(datazntype=="duoxuan"){
							...
							{
								$(datazninput).data("value",$(conthis).data("code"));
