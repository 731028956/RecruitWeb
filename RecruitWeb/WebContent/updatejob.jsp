    	...
    	<div class="mainbody">
    		<div class="nagmr">
    			<div class="topnag">
    				<div class="rwname">
    					<p class="ntk">
    						<span class="ntkname"><input type="text" value="<s:property value="#session.job.companyposition"/>" name="rwname" class="ntktext" disabled="disabled"/></span>
    				...
    				<div class="rwcup">
    					<div class="newtime">
    						更新：
    						<span id="" style="color: #666;"><s:date name="#session.job.updatetime" format="yyyy-MM-dd"/></span>
    						
    					</div>
    				</div>
    				<div class="rwbtn">
    						<span class="reflash">刷新</span>
    						<a href="showjobfromcompany.jsp"><span class="reflash yulan" >预览</span></a>
    		...
    		<form action="Updatejob" method="post" id="form">
    		<div id="app">
    					...
    					<div class="cbox">
    						<div class="bline1" style="display: inline-block;">
    							<div class="c c2">
    								...
    								<li>*</li>
    								<div class="ntxt">
    									<input type="text" maxlength="20" class="ef" name="companyposition" value='<s:property value="#session.job.companyposition"/>'/>
    							...
    							<div class="c c4">
    								...
    								<div class="ntxt" style="width:214px;">
    									<input type="text" maxlength="20" class="ef" name="jobpeople" value='<s:property value="#session.job.jobpeople"/>'/>
    						...
    						<input type="hidden" value='<s:property value="#session.job.gzjy"/>' id="gzjy">
    						<input type="hidden" value='<s:property value="#session.job.educationbackground"/>' id="xuewei">
    						<div class="bline1" style="display: inline-block;">
    							<div class="c c2">
    								<label>工作经验</label>
    								<li>*</li>
    							...
    							<div class="c c4">
    								<label>工作地点</label>
    									<li>*</li>
    								<div class="ntxt">
    									<input type="text" class="area-danxuan" value='<s:property value="#session.job.workadress"/>' data-value="" name="workadress" style="width: 198px;height: 28px;border: 1px solid #ddd;padding-left:14px;border-radius:5% ;" />
    						...
    						<div class="bline1" style="display: inline-block;">
    							<div class="c c2">
    								...
    								<li>*</li>
    								<div class="ntxt">
    									<input type="text" maxlength="20" class="ef" name="salary" value='<s:property value="#session.job.salary"/>'/>	
    								</div>
    								<div class="info">
	    								<b></b>
	    							</div>
    						...
    						<div class="bline1"  style="height: 150px;">
    							<div class="c c2" style="float: none;">
    								<label>职位信息</label>
    								<li>*</li>
    								<pre><textarea style="width: 400px;height: 150px;overflow-x: hidden;" name="occupatroninfo" ><s:property value="#session.job.occupatroninfo"/>
    						...
    						<div class="bline1" style="height: 150px;">
    							<div class="c c2" style="float: none;">
    								<label>招聘要求</label>
    								<li>*</li>
    								<pre><textarea style="width: 400px;height: 150px;overflow-x: hidden;" name="recruitmentrequirement" value='<s:property value="#session.job.recruitmentrequirement"/>'><s:property value="#session.job.recruitmentrequirement"/>	
    								</textarea></pre>	
    							</div>
    						</div>
    						<div class="bline1" style="height: 150px;">
    							<div class="c c2" style="float: none;">
    								<label>其它要求</label>
    								<li>*</li>
    									<pre><textarea style="width: 400px;height: 150px;overflow-x: hidden;" name="other" ><s:property value="#session.job.other"/></textarea></pre>
    							</div>
    						</div>
