    ...
    <body>
    	...
    	<div class="mainbody">
    		<div class="worktitle">
    			...
    			<div class="lftitle">
    				<h1 style="float: left;">	
    					<s:property value="#session.job.companyposition"/>
    				</h1>
    				<span class="h1place">工作地址:<s:property value="#session.job.workadress"/></span>
    				<strong><s:property value="#session.job.salary"/></strong>
    			</div>
    		...
    		<div  class="mfmf">
    				<p>
    					...
    					<s:property value="#session.job.gzjy"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;招1人&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;03-13发布
    		...
    		<div class="tftf">
    		   ...
    		   <pre  class="ppee"><s:property value="#session.job.occupatroninfo"/></pre>
				<p>岗位要求：</p><pre  class="ppee"><s:property value="#session.job.recruitmentrequirement"/></pre>
				<p>其他</p>
    			<pre  class="ppee"><s:property value="#session.job.other"/></pre>
    		...
    		<div class="tftf">
				...
				<div>
					上班地址：<s:property value="#session.job.linkadress"/>
    		...
    		<div class="tftf">
				...
				<div>
					<span><pre  class="ppee"><s:property value="#session.company.profile"/></pre></span>		
				</div>
    		</div>
    	</div>
    	<input type="hidden" value='<s:property value="#session.job.state"/>' id="state"/>
    	<div class="tipbgcolor"></div>
    	<div class="tip">
    			<div class="stip">提示</div>
    			<form method="post" name="form1"> 
    				
    				<input type="hidden" value='<s:property value="#session.job.id"/>' id="jobid"/>
