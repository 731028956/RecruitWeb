...
<html>
    ...
    <body>
    	...
    	<div class="head4" style="background-color: #008080; color: white;">
    		...
    		<div class="person">
    			<img src="${pageContext.request.contextPath}/img/<s:property value="#session.image"/>?temp=<%=Math.random()%>" class="face" />
    		...
    		<div class="info">
    			...
    			<div>
    				<ul>
	    				<li class="top1">
	    					...
	    					<span style="vertical-align:top"><s:property value="#session.resume.workstate" /></span>			
	    				</li>
	    				<li class="top1">
	    					<img src="img/mail.png" width="20px" height="20px" />
	    					<span style="vertical-align:top"><s:property value="#session.user.useremail"/></span>		
	    				</li>
	    				<li class="top1">
	    					<img src="img/iphone.png" width="20px" height="20px" />
	    					<span style="vertical-align:top"><s:property value="#session.user.userphone"/></span>
	    				</li>
    				</ul>
    			</div>
    			<br>
    			...
    			<span style="vertical-align:top"><s:property value="#session.user.sex" />|<s:property value="#session.user.age" /> (<s:date name="#session.user.birthday" format="yyyy-MM-dd"/>)|现居住<s:property value="#session.user.adress"/>|<s:property value="#session.user.gzjy" /></span>
    			</div>
    		</div>
    	...
    	<div class="head4">
    		...
    		<table class="mleft">    			
    			<tr>
    				...
    				<td class="sright"><s:property value="#session.resume.salary" /></td>
    				
    			</tr>
    			<tr>
    				<td class="sleft">职能：</td>
    				<td class="sright"><s:property value="#session.resume.ExpectPosition" /></td>
    				
    			</tr>
    			<tr>
    				<td class="sleft">到岗时间：</td>
    				<td class="sright"><s:property value="#session.resume.dgsj" />	 </td>
    		...
    		<table class="mleft">
    			...
    			<tr>
    				...
    				<td class="sright"><s:property value="#session.resume.workplace" /></td>
    				
    			</tr>
    			<tr>
    				<td class="sleft">行业：</td>
    				<td class="sright"><s:property value="#session.resume.ExpectIndustry" /></td>
    				
    			</tr>
    			<tr>
    				<td class="sleft">工作类型：</td>
    				<td class="sright"><s:property value="#session.resume.widcheck" /></td>
