...
public class NewjobAction extends ActionSupport{
	...
	public String execute() throws Exception {
		...
		System.out.println(cp.getCompanyid()+"id");
		Job job=new Job(cp.getCompanyid(),companyposition,jobpeople, workadress, gzjy, occupatroninfo, recruitmentrequirement, other,salary,linkadress,educationbackground);
